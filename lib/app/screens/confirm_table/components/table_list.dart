...
class TableList extends StatefulWidget {
  const TableList({Key? key, required this.statusId}) : super(key: key);
  final int statusId;
  @override
...
class ExpandKitchenItem extends StatelessWidget {
  const ExpandKitchenItem({required this.table, required this.callback}) : super();
    ...
    return ExpansionTileCard(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [Expanded(child: Text('time.time'.tr + ': ${DateFormat('H:mm dd/MM/yy').format(DateTime.parse(table.updatedAt!).toLocal())}'))],
          ),
        ),
        Padding(
