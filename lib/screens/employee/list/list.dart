              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(prefixIcon: Icon(Icons.search, size: 35), border: InputBorder.none, hintText: 'common.search_employee'.tr),
                  ),
                ),
              ),
              Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('report.total_order'.tr + ': ' + employee!.totalOrder.toString(), style: TextStyle(color: Colors.grey)),
                Icon(
