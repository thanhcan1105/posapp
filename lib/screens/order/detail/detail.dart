                                      ...
                                      child: controller.order.value.note != null && controller.order.value.note != ''
                                          ? Row(
                                              children: [
                                                Expanded(
                                                    child: Text(
                                                  'common.note'.tr + ': ' + controller.order.value.note!,
                                    ...
                                    child: controller.order.value.table != null
                                        ? Row(
                                            children: [
                                              Expanded(
                                                  child: Text(
                                                'label.table'.tr + ': ' + controller.order.value.table!.name!,
                                                style: Palette.textStyle(),
                                              )),
                                              Spacer(),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: controller.order.value.status!.last.title == 'pending'
                                              ...
                                              //     radius: 15,
                                              //     buttonText: 'label.swipe_to_confirm'.tr,
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'common.add_note_order',
                          ),
                          maxLines: 5,
                        ),
                      ],
          ...
          InkWell(
            ...
            child: Row(
              children: [
                ...
                Text(lastStatus!.last.statusLabel, style: TextStyle(color: lastStatus!.last.statusColor)),
                SizedBox(
                  width: 5,
                ),
                Icon(
