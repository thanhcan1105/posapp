            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      'common.total'.tr + ': ${$Number.numberFormat(listProductController.totalPrice.value)} đ',
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'label.total_value_warehouse'.tr + ': ${$Number.numberFormat(listProductController.totalPrice.value)} đ',
