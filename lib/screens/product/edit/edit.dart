                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text('label.detail_item'.tr, style: GoogleFonts.roboto(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'label.promotional_price'.tr,
                        labelStyle: GoogleFonts.roboto(color: Colors.blueGrey),
                      ),
                    ),
                    TextFormField(
  ...
  Container buildNamePrice() {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.all(15),
        child: Column(
          children: [TextFormField(controller: editProductController.nameProduct, onChanged: editProductController.onChangeNameProduct, decoration: InputDecoration(labelText: 'Tên sản phẩm ', labelStyle: GoogleFonts.roboto(color: Colors.blueGrey))), TextFormField(keyboardType: TextInputType.number, controller: editProductController.priceProduct, onChanged: editProductController.onChangePriceProduct, decoration: InputDecoration(labelText: 'Giá bán', labelStyle: GoogleFonts.roboto(color: Colors.blueGrey)))],
        ),
      ),
    );
  }
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  editProductController.labelName.value,
