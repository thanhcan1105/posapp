              ...
              ? Column(
                  ...
                  children: [
                    Obx(() => FilterDateContainer(
                          label: controller.typeFilterLabel,
                        )),
                    SizedBox(
                      height: 20,
                    ),
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            Text(
              "${amount != null ? '${$Number.numberFormat(amount!)} ${isNumber != null ? '' : 'đ'}' : title}",
              style: TextStyle(
            ...
            Row(
              ...
              children: [
                bestDay != null ? Text('${'report.best_day'.tr}: $bestDay', style: TextStyle(color: Palette.colorCyan, fontWeight: FontWeight.w500)) : Text('${'report.sales'.tr}' + ': ${$Number.numberFormat(bestAmount ?? 0)} đ', style: TextStyle(color: Palette.colorCyan, fontWeight: FontWeight.w500)),
                //: Text(''),
                Icon(
