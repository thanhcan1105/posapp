                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Text(
                                      'time.select_time'.tr + ': ${controller.startDate.value != '' ? '' : ''}',
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(() => controller.startDate.value != ''
                            ? Text(
                                'time.start'.tr + ': ${DateFormat('dd/MM/yyyy').format(DateTime.parse(controller.startDate.value))}',
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(() => controller.endDate.value != ''
                            ? Text(
                                'time.end'.tr + ': ${DateFormat('dd/MM/yyyy').format(DateTime.parse(controller.endDate.value))}',
                                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.blueGrey),
                              )
                            : Container())
                      ],
