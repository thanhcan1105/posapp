          ...
          child: new Hero(
            ...
            child: buttomZoomOut.value <= 300
                ? new Container(
                    ...
                    height: buttomZoomOut.value == 70 ? 50.0 : buttomZoomOut.value,
                    alignment: FractionalOffset.center,
                    decoration: new BoxDecoration(
                      color: const Color.fromRGBO(247, 64, 106, 1.0),
                      borderRadius: buttomZoomOut.value < 400 ? new BorderRadius.all(const Radius.circular(20.0)) : new BorderRadius.all(const Radius.circular(0.0)),
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return new AnimatedBuilder(
      builder: (BuildContext context, Widget? widget) {
        return _buildAnimation(context, widget ?? Container());
      },
